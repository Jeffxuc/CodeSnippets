...
public:
    ...
    /// 设备索引
    /// </PARAM>
    /// <PARAM name = "problemCode" dir = "OUT">
    /// 存储问题代码
    /// </PARAM>
    /// <RETURNS>
    /// 成功返回0 失败返回ErrorCode, 返回系统的GetLastError()
    /// </RETURNS>
    unsigned long GetProblemCode(IN int index, OUT unsigned long& problemCode);
	...
	/// 设备索引
	/// </PARAM>
    /// <PARAM name = "Date" dir = "OUT">
    /// 设备索引
    /// </PARAM>
	/// <RETURNS>
	/// 成功返回日期
	/// </RETURNS>
	unsigned long GetDriverDate(IN int index, OUT wstring& Date);
	...
	/// 成功返回版本
	/// </RETURNS>
	unsigned long GetDriverVersion(IN int index, OUT unsigned int& Version);


    unsigned long GetDriverData_01(IN int index, OUT wstring& date);

    unsigned long GetDriverVersion_01(IN int index, OUT wstring& version);
...
/// 蓝牙设备类
/// </SUMMARY>
class LSetupBluetooth : public LSetupDev
{
public:
    LSetupBluetooth();
    ~LSetupBluetooth();
...
/// 网络设备类
/// </SUMMARY>
class LSetupNet : public LSetupDev
{
public:
    LSetupNet();
    ~LSetupNet();
...
/// 电池设备类
/// </SUMMARY>
class LSetupBattery : public LSetupDev
{
public:
    LSetupBattery();
    ~LSetupBattery();
...
/// USB设备类
/// </SUMMARY>
class LSetupUSB : public LSetupDev
{
public:
	LSetupUSB();
	~LSetupUSB();
